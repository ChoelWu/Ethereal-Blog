        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                @foreach($menu_list as $vo_m)
                    @if(empty($vo_m['children']))
                        <li>
                            <a href="{{ url($vo_m['url']) }}"><i class="fa fa-{{ $vo_m['icon'] }}"></i> <span
                                        class="nav-label">{{ $vo_m['name'] }}</span></a>
                        </li>
                    @else
                        <li>
                            <a href="#"><i class="fa fa-{{ $vo_m['icon'] }}"></i> <span
                                        class="nav-label">{{ $vo_m['name'] }}</span><span
                                        class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse">
                                @foreach($vo_m['children'] as $v)
        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li>
                        <span class="m-r-sm text-muted welcome-message">欢迎使用Ethereal Blog</span>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-messages">
                                ...
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle"
                                             src="{{ asset(config('view.admin_static_path') . '/img/a7.jpg') }}">
                                    </a>
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle"
                                             src="{{ asset(config('view.admin_static_path') . '/img/a4.jpg') }}">
                                    </a>
                                    <div class="media-body ">
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle"
                                             src="{{ asset(config('view.admin_static_path') . '/img/profile.jpg') }}">
                                    </a>
                                    <div class="media-body ">
