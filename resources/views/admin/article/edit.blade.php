...
@section('head_files')
    ...
    <link rel="stylesheet"
          href="{{ asset(config('view.admin_static_path') . '/css/plugins/jasny/jasny-bootstrap.min.css') }}"/>
@endsection
@section('content')
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" id="edit-article-form">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <textarea name="summary" class="form-control" id="" rows="5" style="resize:none"
                                              maxlength="150">{{ $article->summary }}</textarea>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    <div class="btn btn-primary" id="edit-article-submit">保存</div>
                                </div>
                            </div>
                        </form>
                    </div>
...
@section('foot_files')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#edit-article-form').bootstrapValidator({
